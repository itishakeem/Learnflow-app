...
// Inline SVGs — avoids lucide-react version issues
function GoogleIcon() {
  return (
  ...
  return (
    <motion.button
      ...
      className="flex-1 flex items-center justify-center gap-2.5 py-2.5 px-4
                 bg-surface-base border border-surface-border rounded-xl
                 text-sm text-ink-secondary font-medium
                 hover:bg-surface-raised hover:border-brand/25 hover:text-ink-primary
